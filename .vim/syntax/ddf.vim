...
syn match comment_keywords /\<Ident\>\|\<Author\>\|\<Version\>\|\<LastCheckin\>\|\<What id\>\|\<LastEdit date\>\|\<Description\>\|\<To do\>\|\<Data in\>\|\<Data out\>\|\<Error codes\>\|\<History\>\|Input(s)\|Output(s)\|\<Returns\>\|\<Notes\>\|Pre.Cond.\|Post.Cond.\|\<In\>\|\d\{1,2}-\w\{3}-\d\{4}\|\d\{4}-\d\{2}-\d\{2}\|InOut(s)\|Purpose\|\<Date\>/
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

syn match voidClr       /\<void\>\|\<namespace\>\|\<Inline\>\|\<class\>\|\<struct\>\|\<template\>\|\<virtual\>\|\<typename\>\|\<using\>\|\<function\>/
syn match pppClr        /\<public\>\|\<private\>\|\<protected\>/
syn match testClr 	/\<in\>\|\<out\>\|\<inout\>/
syn match scoelho_type /\<vector\>\|\<string\>\|\<list\>\|\<string\>\|\<map\>\|\<auto_ptr\>\|\<type_info\>\|\<iterator\>\|\<const_iterator\>\|\<const_reverse_iterator\>\|\<ostream\>\|\<istringstream\>\|\<int\>\|\<int,\>\|\<bool\>\|\<char\>\|\<double\>\|\<sqlite_int64\>\|\<int16_t\>\|\<int64_t\>\|\<unsigned\>\|\<sqlite3_int64\>\|\<uint64_t\>\|\<enum\>\|\<sqlite3\>\|\<xyvect\>/
syn match operatorsClr 	/=\|!=\|||\|&&\|<<\|>>\|++\|+\|>\|<\|?/
syn match constClr 	/\cNULL\|\ctrue\|\cfalse/
...
syn match testClr /\<for\>\|\<while\>\|\<return\>\|\<if\>\|\<try\>\|\<static\>\|\<const\>\|\<typedef\>\|\<else\>\|\<inline\>\|\<this\>\|\<throw\>\|\<switch\>\|\<case\>\|\<break\>\|\<default\>/

syn match class  /\<interface\>/      
...
syn region str start="\"" end="\"" contains=sql_dll, sql_dml, sql_dcl, sql_dql, sql_others, sql_functions, sql_types, sql_st, numbers, includeFile
