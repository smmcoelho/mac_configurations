...
"syn match defineClr     /\<language\>/
"syn match pppClr        /\<public\>\|\<private\>\|\<protected\>\|\<implements\>/
"syn match operatorsClr 	/\<tracesimulation\>\|\<standardconstructor\>\|\<fullconst\>/
...
""doxygen part""
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"syn match dox_keywords /\<Ident\>\|\<Author\>\|\<Version\>\|\<LastCheckin\>\|\<What id\>\|\<LastEdit date\>\|\<Description\>\|\<To do\>\|\<Data in\>\|\<Data out\>\|\<Error codes\>\|\<History\>\|\d\{1,2}-\w\{3}-\d\{4}/
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

syn match constClr /\<\FALSE>\|\<TRUE\>/

"syn match string /^\w\{2}-\w\d\{2}\w\~/

"method name (with class name)
"syn match method /^\w\{2}-\w\d\{3}\~/
syn match method /^KI-\w\{4}\~/
"syn region method start=/KI-\w\w\{3}\~/ end="\n"


syn region comment start="\w\{2}-\w\{4}@" end="\n"

syn region beginend start=/\*\*\*\*/ end=/\*\*\*\*/
